...
@Service
public class AdministratorCustomizationParametersUpdateService implements AbstractUpdateService<Administrator, CustomizationParameters> {
	...
	@Override
	public void update(final Request<CustomizationParameters> request, final CustomizationParameters entity) {
		assert request != null;
		assert entity != null;
