...
@Service
public class AnonymousStarsCRListService implements AbstractListService<Anonymous, Records> {

	//Internal State -----------------------------
	@Autowired
	AnonymousStarsCRRepository repository;
	...
	public Collection<Records> findMany(final Request<Records> request) {
		...
		result = this.repository.find5Stars();
		return result;
	}
